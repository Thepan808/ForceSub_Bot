...
class Config():
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://avnadmin:AVNS_VSmBG6s_wjj7oSjIijQ@pg-290b8133-botforce73-d2b5.k.aivencloud.com:16908/defaultdb?sslmode=require")
